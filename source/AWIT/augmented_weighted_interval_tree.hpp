...
// definition of nodes of augmented weighted interval tree
struct node
{
...
// definition of AWIT
class augmented_weighted_interval_tree
{
    // set of nodes
    ...
    unsigned int get_weighted_random_sample(const node_log *_log)
    {
...
public:
    ...
    /* constructor */
    augmented_weighted_interval_tree(){}
    ...
    void independent_weighted_range_sampling(const std::pair<unsigned int, unsigned int> &query)
    {
        /*************************/
