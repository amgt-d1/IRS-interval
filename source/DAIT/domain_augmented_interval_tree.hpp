...
//definition of DAIT
class domain_augmented_interval_tree
{
    // set of nodes
    ...
    unsigned int get_random_sample(node_log *_log)
    {
...
public:
    ...
    /* constructor */
    domain_augmented_interval_tree(){}
    ...
    void independent_range_sampling(std::pair<unsigned int, unsigned int> &query)
    {
        /*************************/
        ...
        // {
        //     temp += (candidate[i].right_idx - candidate[i].left_idx + 1);
        // }
        // std::cout << " size: " << temp << "\n";
